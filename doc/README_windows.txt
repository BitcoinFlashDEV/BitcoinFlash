...
Intro
-----
BitcoinFlash (BTFL) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. BitcoinFlash utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run bitcoinflash-qt.exe.

BitcoinFlash Core is the original BitcoinFlash client and it builds the backbone of the network.
However, it downloads and stores the entire history of BitcoinFlash transactions;
