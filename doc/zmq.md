...
The BitcoinFlash Core daemon can be configured to act as a trusted "border
router", implementing the bitcoinflash wire protocol and relay, making
...
The ZeroMQ feature in BitcoinFlash Core requires ZeroMQ API version 4.x or
...
during the *configure* step of building bitcoinflashd:
