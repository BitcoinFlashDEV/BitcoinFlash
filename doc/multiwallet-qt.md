...
In order to support loading of multiple wallets in bitcoinflash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitcoinflash.cpp.
...
Changes to bitcoinflash.cpp
----------------------
bitcoinflash.cpp is the entry point into bitcoinflash-qt, and as such, will require some minor modifications to provide hooks for
