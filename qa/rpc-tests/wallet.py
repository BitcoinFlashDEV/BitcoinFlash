...
#   c) node1 mines 32 blocks, so now node 0 has 500000BTFL, node 1 has 4250BTFL, node2 has none.
#   d) node0 sends 601 BTFL to node2, in two transactions (301 BTFL, then 300 BTFL).
