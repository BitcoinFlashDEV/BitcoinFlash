...
// Copyright (c) 2017-2018 The BitcoinFlash developers
...
public:
    ...
    /// Is the inputs associated with this public key? (and there is BTFL collateral - checking if valid masternode)
