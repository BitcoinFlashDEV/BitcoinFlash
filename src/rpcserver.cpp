...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop BitcoinFlash server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "BitcoinFlash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BitcoinFlash features */
        {"bitcoinflash", "masternode", &masternode, true, true, false},
        {"bitcoinflash", "listmasternodes", &listmasternodes, true, true, false},
        {"bitcoinflash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitcoinflash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitcoinflash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitcoinflash", "masternodedebug", &masternodedebug, true, true, false},
        {"bitcoinflash", "startmasternode", &startmasternode, true, true, false},
        {"bitcoinflash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitcoinflash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitcoinflash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitcoinflash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitcoinflash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitcoinflash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitcoinflash", "mnbudget", &mnbudget, true, true, false},
        {"bitcoinflash", "preparebudget", &preparebudget, true, true, false},
        {"bitcoinflash", "submitbudget", &submitbudget, true, true, false},
        {"bitcoinflash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitcoinflash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitcoinflash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitcoinflash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitcoinflash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitcoinflash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitcoinflash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitcoinflash", "checkbudgets", &checkbudgets, true, true, false},
        {"bitcoinflash", "mnsync", &mnsync, true, true, false},
        {"bitcoinflash", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> bitcoinflash-cli " + methodname + " " + args + "\n";
}
