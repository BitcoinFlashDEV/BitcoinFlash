...
/** Utility functions used by the BitcoinFlash Qt UI.
 */
namespace GUIUtil
{
...
// Render BTFL addresses in monospace font
...
// Parse "bitcoinflash:" URI into recipient object, return true on successful parsing
