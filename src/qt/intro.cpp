...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BitcoinFlash Core"),
     ...
     * override -datadir in the bitcoinflash.conf file in the default data directory
     * (to be consistent with bitcoinflashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
