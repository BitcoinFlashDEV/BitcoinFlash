...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("BitcoinFlash Core");
    ...
    QString copyrightTextBTFL = QChar(0xA9) + QString(" 2018-2018 ").arg(COPYRIGHT_YEAR) + QString(tr("The BitcoinFlash Core developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextBTFL);
