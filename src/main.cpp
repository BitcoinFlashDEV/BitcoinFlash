...
#if defined(NDEBUG)
#error "BitcoinFlash cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in ubtfl) are considered zero fee (for relaying and mining)
...
{
    RenameThread("bitcoinflash-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // BTFL: We use certain sporks during IBD, so check to see if they are
