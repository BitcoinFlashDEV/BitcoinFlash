...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitcoinFlash Core bitcoinflash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitcoinflash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinflash transaction") + "\n" +
                               "  bitcoinflash-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinflash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoinflash transaction
