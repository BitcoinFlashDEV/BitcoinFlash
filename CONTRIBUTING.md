Contributing to BitcoinFlash Core
==================================

The BitcoinFlash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BitcoinFlash Core project, and is not to be
confused with overall BitcoinFlash Network Protocol consensus changes.

Whether a pull request is merged into BitcoinFlash Core rests with the project merge
...
Patches that change BitcoinFlash consensus rules are considerably more involved than
...
Where a patch set proposes to change the BitcoinFlash consensus, it must have been
...
The project leader is the release manager for each BitcoinFlash Core release.
